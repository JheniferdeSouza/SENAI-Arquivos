...
public class ViewJTable extends javax.swing.JFrame {
    ...
    private void initComponents() {
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(txtSemente, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(jLabel2))
                                .addGap(18, 18, 18)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(jLabel3)
                                    .addComponent(txtAdulto, javax.swing.GroupLayout.PREFERRED_SIZE, 189, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txtSemente, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jTProdutos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "PaisDeOrigem", "Semente", "Adulto"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        p.setPaisDeOrigem(txtPais.getText());
        p.setSemente(Integer.parseInt(txtSemente.getText()));
        p.setAdulto(Double.parseDouble(txtAdulto.getText()));
        dao.create(p);
...
//        System.out.println("Linha selecionada: "+jTProdutos.getSelectedRow());
    ...
    private void jTProdutosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTProdutosMouseClicked
        ...
        if (jTProdutos.getSelectedRow() != -1) {
            ...
            txtPais.setText(jTProdutos.getValueAt(jTProdutos.getSelectedRow(), 2).toString());
            txtSemente.setText(jTProdutos.getValueAt(jTProdutos.getSelectedRow(), 3).toString());
            txtAdulto.setText(jTProdutos.getValueAt(jTProdutos.getSelectedRow(), 4).toString());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (jTProdutos.getSelectedRow() != -1) {
            ...
            p.setNome(txtNome.getText());
            p.setPaisDeOrigem(txtPais.getText());
            p.setSemente(Double.parseDouble(txtSemente.getText()));
            p.setAdulto(Double.parseDouble(txtAdulto.getText()));
            p.setId((int) jTProdutos.getValueAt(jTProdutos.getSelectedRow(), 0));
            dao.update(p);
